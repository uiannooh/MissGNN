...
def add_uci_subparser(subparsers):
    ...
    subparser.add_argument('--data', type=str, default='yacht')
    subparser.add_argument('--train_edge', type=float, default=0.7)  # non-missing data
    ...
    subparser.add_argument('--node_mode', type=int, default=1)  # 0: feature onehot, sample all 1; 1: all onehot